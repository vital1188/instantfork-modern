...
-- RLS Policies
DROP POLICY IF EXISTS "Users can view their own claimed deals" ON claimed_deals;
CREATE POLICY "Users can view their own claimed deals" ON claimed_deals
    FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create their own claimed deals" ON claimed_deals;
CREATE POLICY "Users can create their own claimed deals" ON claimed_deals
    FOR INSERT WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Restaurants can view claims for their deals" ON claimed_deals;
...
DROP POLICY IF EXISTS "Restaurants can update claims for their deals" ON claimed_deals;
